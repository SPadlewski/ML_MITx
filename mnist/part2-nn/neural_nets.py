...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_activation = output_layer_activation(hidden_layer_weighted_input)# TODO (3 by 1 matrix)
        ...
        class NeuralNetwork(NeuralNetworkBase):
            ...
            hidden_layer_error = np.multiply(output_derivative_vec(activated_output),
                                             self.hidden_to_output_weights.transpose()) * output_layer_error  # ? dC/dv=df(u)/dv * dC/df(u1)# (3 by 1 matrix)
