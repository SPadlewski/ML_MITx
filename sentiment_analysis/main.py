...
print('Pegasos train accuracy:', avg_peg_train_accuracy)
print('Pegasos test accuracy:',avg_peg_test_accuracy)
#-------------------------------------------------------------------------------
...
# T=25
# L=0.01
# best_theta = p1.pegasos(train_bow_features,train_labels,T=T,L=L)[0]
